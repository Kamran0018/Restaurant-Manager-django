...
SECRET_KEY = 'django-insecure-r3st@ur@nt-m@n@g3m3nt-s3cr3t-k3y-ch@ng3-1n-pr0duct10n'
...
# To switch to PostgreSQL, set DATABASE_ENGINE=postgresql in environment
...
# Messages framework - Bootstrap 5 CSS classes
